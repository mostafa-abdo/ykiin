                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="terms_and_conditions"  class="form-control" rows="5" id="terms_and_conditions">{{$event->terms_and_conditions}}</textarea>
                                    </div>

                                    <div class="form-group">
                                        <label for="privacy_policy">{{__('Privacy Policy')}}</label>
                                        <textarea name="privacy_policy"  class="form-control" rows="5" id="privacy_policy">{{$event->privacy_policy}}</textarea>
                                    </div>
