    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Counterup Section Settings')}}</h4>

                        <form action="{{route('admin.about.counterup')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                ...
                                <small>{{__('recommended image size is 19200x700 pixel')}}</small>
                            </div>
