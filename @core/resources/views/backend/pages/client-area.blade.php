                                    ...
                                    <td>
                                       ...
                                       @can('client-area-edit')
                                        <a href="#"
                                           ...
                                           data-bs-target="#brand_item_edit_modal"
                        ...
                        <form action="{{route('admin.client.area')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="media-upload-btn-wrapper">
                                    ...
                                    <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="Select Brand Image" data-modaltitle="Upload Brand Image" data-bs-toggle="modal" data-bs-target="#media_upload_modal">
                                        {{__('Upload Image')}}
                                    </button>
                                </div>
