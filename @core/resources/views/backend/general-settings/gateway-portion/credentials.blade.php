<div class="accordion-wrapper">
    <div id="accordion-payment">
        ...
        <div class="card">
            ...
            <div id="senangpay_settings_content" class="collapse"
                 data-parent="#accordion-payment">
                <div class="card-body">
                    <div class="payment-notice alert alert-warning">
                        <p>{{__('If your currency is not available in Senangpay, it will convert your currency value to MYR based on your currency exchange rate.')}}</p>
                    </div>
                    <label for="paytm_gateway"><strong>{{__('Enable/Disable Senangpay')}}</strong></label>
                    <label class="switch">
                        <input type="checkbox" name="senangpay_gateway"
                               @if(!empty(get_static_option('senangpay_gateway')))
                                   checked
                               @endif id="senangpay_gateway">
                        <span class="slider onff"></span>-
                    </label>
                </div>
                <div class="form-group">
                    <label for="senangpay_test_mode"><strong>{{__('Enable Test Mode For Senangpay')}}</strong></label>
                    <label class="switch">
                        <input type="checkbox" name="senangpay_test_mode" @if(!empty(get_static_option('senangpay_test_mode'))) checked @endif >
                        <span class="slider onff"></span>
                    </label>
                </div>
                <div class="form-group">
                    <label for="site_logo"><strong>{{__('Senangpay Logo')}}</strong></label>
                    <div class="media-upload-btn-wrapper">
                        <div class="img-wrap">
                            @php
                                $senangpay_img = get_attachment_image_by_id(get_static_option('senangpay_preview_logo'),null,true);
                                $senangpay_image_btn_label = __('Upload Image');
                            @endphp
                            @if (!empty($senangpay_img))
                                <div class="attachment-preview">
                                    <div class="thumbnail">
                                        <div class="centered">
                                            <img class="avatar user-thumb" src="{{$senangpay_img['img_url']}}" alt="">
                                        </div>
                                    </div>
                                </div>
                                @php  $senangpay_image_btn_label = __('Change Image'); @endphp
                            @endif
                        </div>
                        <input type="hidden" id="senangpay_preview_logo"
                               name="senangpay_preview_logo"
                               value="{{get_static_option('senangpay_preview_logo')}}">
                        <button type="button"
                                class="btn btn-info media_upload_form_btn"
                                data-btntitle="{{__('Select Image')}}"
                                data-modaltitle="{{__('Upload Image')}}"
                    ...
                    <small class="form-text text-muted">{{__('allowed image format: jpg,jpeg,png,webp. Recommended image size 160x50')}}</small>
                </div>
                <div class="form-group">
                    <label for="senangpay_set_merchant_id">{{__('Set Merchant Id')}}</label>
                    <input type="text" name="senangpay_set_merchant_id" id="senangpay_set_merchant_id" value="{{get_static_option('senangpay_set_merchant_id')}}" class="form-control">
                </div>
                <div class="form-group">
                    <label for="senangpay_set_secret_key">{{__('Set Secret Key')}}</label>
                    <input type="text" name="senangpay_set_secret_key" id="senangpay_set_secret_key" value="{{get_static_option('senangpay_set_secret_key')}}" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div id="iyzipay_settings_content" class="collapse"
                ...
                <div class="card-body">
                    <div class="payment-notice alert alert-warning">
                        <p>{{__('If your currency is not available in Iyzipay, it will convert your currency value to ["TRY", "USD", "EUR", "GBP", "IRR", "NOK", "RUB", "CHF"] based on your currency exchange rate.')}}</p>
                    </div>
                    <label for="paytm_gateway"><strong>{{__('Enable/Disable Iyzipay')}}</strong></label>
                    <label class="switch">
                        <input type="checkbox" name="iyzipay_gateway"
                               @if(!empty(get_static_option('iyzipay_gateway')))
                                   checked
                               @endif id="iyzipay_gateway">
                        <span class="slider onff"></span>-
                    </label>
                </div>
                <div class="form-group">
                    <label for="iyzipay_test_mode"><strong>{{__('Enable Test Mode For Iyzipay')}}</strong></label>
                    <label class="switch">
                        <input type="checkbox" name="iyzipay_test_mode" @if(!empty(get_static_option('iyzipay_test_mode'))) checked @endif >
                        <span class="slider onff"></span>
                    </label>
                </div>
                <div class="form-group">
                    <label for="site_logo"><strong>{{__('Iyzipay Logo')}}</strong></label>
                    <div class="media-upload-btn-wrapper">
                        <div class="img-wrap">
                            @php
                                $iyzipay_img = get_attachment_image_by_id(get_static_option('iyzipay_preview_logo'),null,true);
                                $iyzipay_image_btn_label = __('Upload Image');
                            @endphp
                            @if (!empty($iyzipay_img))
                                <div class="attachment-preview">
                                    <div class="thumbnail">
                                        <div class="centered">
                                            <img class="avatar user-thumb" src="{{$iyzipay_img['img_url']}}" alt="">
                                        </div>
                                    </div>
                                </div>
                                @php  $iyzipay_image_btn_label = __('Change Image'); @endphp
                            @endif
                        </div>
                        <input type="hidden" id="iyzipay_preview_logo"
                               name="iyzipay_preview_logo"
                               value="{{get_static_option('iyzipay_preview_logo')}}">
                        <button type="button"
                                class="btn btn-info media_upload_form_btn"
                                data-btntitle="{{__('Select Image')}}"
                                data-modaltitle="{{__('Upload Image')}}"
                ...
                <div class="form-group">
                    <label for="iyzipay_set_secret_key">{{__('Set Secret Key')}}</label>
                    <input type="text" name="iyzipay_set_secret_key" id="iyzipay_set_secret_key" value="{{get_static_option('iyzipay_set_secret_key')}}" class="form-control">
                </div>
                <div class="form-group">
                    <label for="iyzipay_set_api_key">{{__('Set Api Key')}}</label>
                    <input type="text" name="iyzipay_set_api_key" id="iyzipay_set_api_key" value="{{get_static_option('iyzipay_set_api_key')}}" class="form-control">
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div id="awdpay_settings_content" class="collapse"
                ...
                <div class="card-body">
                    <div class="payment-notice alert alert-warning">
                        <p>{{__('If your currency is not available in Awdpay, it will convert your currency value to ["USD", "EUR", "XOF"] based on your currency exchange rate.')}}</p>
                    </div>
                    <label for="paytm_gateway"><strong>{{__('Enable/Disable Awdpay')}}</strong></label>
                    <label class="switch">
                        <input type="checkbox" name="awdpay_gateway"
                               @if(!empty(get_static_option('awdpay_gateway')))
                                   checked
                               @endif id="awdpay_gateway">
                        <span class="slider onff"></span>-
                    </label>
                </div>
                <div class="form-group">
                    <label for="awdpay_test_mode"><strong>{{__('Enable Test Mode For Awdpay')}}</strong></label>
                    <label class="switch">
                        <input type="checkbox" name="awdpay_test_mode" @if(!empty(get_static_option('awdpay_test_mode'))) checked @endif >
                        <span class="slider onff"></span>
                    </label>
                </div>
                <div class="form-group">
                    <label for="site_logo"><strong>{{__('Awdpay Logo')}}</strong></label>
                    <div class="media-upload-btn-wrapper">
                        <div class="img-wrap">
                            @php
                                $awdpay_img = get_attachment_image_by_id(get_static_option('awdpay_preview_logo'),null,true);
                                $awdpay_image_btn_label = __('Upload Image');
                            @endphp
                            @if (!empty($awdpay_img))
                                <div class="attachment-preview">
                                    <div class="thumbnail">
                                        <div class="centered">
                                            <img class="avatar user-thumb" src="{{$awdpay_img['img_url']}}" alt="">
                                        </div>
                                    </div>
                                </div>
                                @php  $awdpay_image_btn_label = __('Change Image'); @endphp
                            @endif
                        </div>
                        <input type="hidden" id="awdpay_preview_logo"
                               name="awdpay_preview_logo"
                               value="{{get_static_option('awdpay_preview_logo')}}">
                        <button type="button"
                                class="btn btn-info media_upload_form_btn"
                                data-btntitle="{{__('Select Image')}}"
                                data-modaltitle="{{__('Upload Image')}}"
                ...
                <div class="form-group">
                    <label for="awdpay_set_private_key">{{__('Set Private Key')}}</label>
                    <input type="text" name="awdpay_set_private_key" id="awdpay_set_private_key" value="{{get_static_option('awdpay_set_private_key')}}" class="form-control">
                </div>
                <div class="form-group">
                    <label for="awdpay_set_logo_url">{{__('Set Logo Url')}}</label>
                    <input type="text" name="awdpay_set_logo_url" id="awdpay_set_logo_url" value="{{get_static_option('awdpay_set_logo_url')}}" class="form-control">
                </div>
            </div>
        </div>
