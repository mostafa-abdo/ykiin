                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="margin-top-20">
                            ...
                            @php
                                $withdraw_able_amount_without_admin_charge = optional($withdraw->cause)->raised - optional(optional($withdraw->cause)->withdraws)->where('payment_status','!=','reject')->pluck('withdraw_request_amount')->sum();
                               $charge_text = '';
                            ...
                            @endif
                            <li><strong>{{__('Payment Account Details ')}}:</strong> <br>
                                @php $fields = ''; @endphp
