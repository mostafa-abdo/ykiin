                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.donations.settings')}}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="allow_user_to_add_custom_tip_in_donation" @if(!empty(get_static_option('allow_user_to_add_custom_tip_in_donation'))) checked @endif >
                                    <span class="slider"></span>
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="transaction_minimum_charge_amount_type">{{__('Transaction Fee Type')}}</label>
                                <select class="form-control" name="transaction_minimum_charge_amount_type">
                                    <option value="fixed"
                                            @if (get_static_option('transaction_minimum_charge_amount_type') == 'fixed')  selected @endif >{{ __('Fixed Amount') }}</option>
                                    <option value="percentage"
                                            @if (get_static_option('transaction_minimum_charge_amount_type') == 'percentage') selected @endif>{{ __('Percentage Amount') }}</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="transaction_minimum_charge_amount">{{__('Transaction Minimum Fee Amount')}}</label>
                                <input type="text" name="transaction_minimum_charge_amount" class="form-control"
                                       value="{{get_static_option('transaction_minimum_charge_amount')}}">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="donation_page_qr_code_title">{{__('Qr Code Title')}}</label>
                                <input type="text" class="form-control" name="donation_page_qr_code_title" value="{{get_static_option('donation_page_qr_code_title')}}">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="donation_terms_and_conditions">{{__('Terms & Conditions')}}</label>
                                <select class="form-control" name="donation_terms_and_conditions">
                                    <option value="">{{ __('Select Terms & Conditions Pages to show') }}</option>
                                    @foreach($pages as $page)
                                        <option value="{{ $page->id }}" @if (get_static_option('donation_terms_and_conditions') == $page->id)  selected @endif >{{ __($page->title) }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <label for="donation_privacy_policy">{{__('Privacy Policy')}}</label>
                                <select class="form-control" name="donation_privacy_policy">
                                    <option value="">{{ __('Select Privacy Policy Pages to show') }}</option>
                                    @foreach($pages as $page)
                                        <option value="{{ $page->id }}" @if (get_static_option('donation_privacy_policy') == $page->id)  selected @endif >{{ __($page->title) }}</option>
                                    @endforeach
                                </select>
                                <span class="info-text">{{__('you can create new pages if you do not have.')}}</span>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="navbar_button">{{__('Show/Hide Donate QR code')}}</label>
                                <label class="switch">
                                    <input type="checkbox" name="donation_page_qr_code_show_hide"
                                           @if(!empty(get_static_option('donation_page_qr_code_show_hide'))) checked @endif >
                                    <span class="slider"></span>
                                </label>
                            </div>
