    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__("Donations Form Builder")}}</h4>
                        <div class="alert alert-danger alert-block ">
                            <strong><i class="ti-hand-point-right mr-1"></i> {{__("Note: Please, don't add Name & Email Form Fields here!")}}</strong>
                        </div>
                        <form action="{{route('admin.form.builder.donation.form')}}" method="Post">@csrf
                            {!! render_drag_drop_form_builder_markup(get_static_option('donation_page_form_fields')) !!}
