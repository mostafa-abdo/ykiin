                    ...
                    <li class="main_dropdown @if(request()->is(['admin-home/donations/*','admin-home/donations'])) active @endif ">
                        ...
                        <ul class="collapse">
                            ...
                            @can('donation-withdraw-list')
                                ...
                                <li class="{{active_menu('admin-home/donations/withdraw/payment/gateway')}}"><a
                                            href="{{route('admin.all.donation.withdraw.payment.gateway')}}">{{__('Withdraw Payment Gateways')}}</a>
                                </li>
                            @endcan
