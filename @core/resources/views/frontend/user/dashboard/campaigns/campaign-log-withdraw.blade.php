            ...
            <table class="table table-striped">
                ...
                <tbody>
                  ...
                  @foreach($withdraw_logs as $data)
                      @php $fields = ''; @endphp
                      @foreach (unserialize($data->gateway_fields) as $key => $value)
                          @php
                        ...
                        <td>
                            <ul>
                                ...
                                <li><strong>{{__("Payment Gateway")}}:</strong>
                                    {{ ucfirst($data?->gateway_name?->name)}}
                                    @if(!empty($data->payment_gateway) && $data->payment_gateway != null)
                ...
                <form action="{{route('user.campaign.withdraw.submit')}}" method="post" id="donation_withdraw_form">
                    <div class="modal-body">
                        ...
                        <div class="field_wrap d-none">
                            ...
                            <div class="gateway-information-wrapper mt-3 mb-3">
