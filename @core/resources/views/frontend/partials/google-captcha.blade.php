@php
    $site_google_captcha_enable = get_static_option('site_google_captcha_enable');
    $site_google_captcha_v3_site_key = get_static_option('site_google_captcha_v3_site_key');
@endphp
@if(!empty($site_google_captcha_v3_site_key) && !empty($site_google_captcha_enable) && in_array(request()->path(),['home/01','home/02','home/03','home/04','/']))
