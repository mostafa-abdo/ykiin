            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="widget-area">
                        ...
                        @if(!empty(get_static_option('event_page_qr_code_show_hide')))
                            <div class="widget event-info">
                                <h4 class="widget-title">{{ get_static_option('event_page_qr_code_title') ?? __('QR code') }}</h4>
                                <div class="content">
                                    {!! $qr_code !!}
                                    <br>
                                    <div class="btn-wrapper mt-3">
                                        <a href="{{ route('frontend.events.qrcode.download', $event->slug) }}" class="boxed-btn btn-sm reverse-color">{{ __('Download') }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
