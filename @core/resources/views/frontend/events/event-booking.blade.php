                        ...
                        <div class="order-tab-wrap">
                            ...
                            <div class="tab-content" >
                                ...
                                <div class="tab-pane fade @if(auth()->check()) show active @endif" id="nav-profile" role="tabpanel">
                                    ...
                                    @endif
                                    <form method="post" action="{{route('frontend.event.payment.confirm')}}" enctype="multipart/form-data">
                                        ...
                                        @if(get_static_option('event_terms_and_conditions') && get_static_option('event_privacy_policy'))
                                            <!-- Terms and Conditions -->
                                            <div id="termsAndConditions">
                                                <label>
                                                    <input type="checkbox" name="agreeTerms" required>
                                                    I agree to the <a href="{{ route('frontend.dynamic.page',[getSlugByPageId(get_static_option('event_terms_and_conditions')), get_static_option('event_terms_and_conditions')]) }}" target="_blank">terms and conditions</a> and <a href="{{ route('frontend.dynamic.page',[getSlugByPageId(get_static_option('event_privacy_policy')), get_static_option('event_privacy_policy')]) }}" target="_blank">privacy policy</a>.
                                                </label>
                                            </div>
                                        @endif
...
@endsection
@section('scripts')
@if(!empty(get_static_option('site_google_captcha_v3_site_key')) && !empty(get_static_option('site_google_captcha_enable')))
