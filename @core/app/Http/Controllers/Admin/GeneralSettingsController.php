...
class GeneralSettingsController extends Controller
{
    ...
    public function update_payment_settings(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'site_manual_payment_name' => 'nullable|string|max:255',
            'manual_payment_preview_logo' => 'nullable|string|max:255',
        ...
        $save_data = [
            ...
            'awdpay_gateway',
            'awdpay_test_mode',
            'awdpay_set_private_key',
            'awdpay_set_logo_url',

            'senangpay_preview_logo',
            'senangpay_gateway',
            'senangpay_test_mode',
            'senangpay_set_merchant_id',
            'senangpay_set_secret_key',

            'iyzipay_preview_logo',
            'iyzipay_gateway',
            'iyzipay_test_mode',
            'iyzipay_set_secret_key',
            'iyzipay_set_api_key',
        ...
        update_static_option('paytabs_test_mode', $request->paytabs_test_mode);
        update_static_option('paytabs_region', $request->pay_tabs_region);
        update_static_option('paytabs_profile_id', $request->pay_tabs_profile_id);
        update_static_option('paytabs_server_key', $request->pay_tabs_server_key);
        ...
        $env_val['PF_MERCHANT_ENV'] = $request->payfast_test_mode === 'on'  ? 'true' : 'false';
        ...
        $env_val['BILLPLZ_TEST_MODE'] = $request->billplz_test_mode ? 'sandbox' : 'production';
