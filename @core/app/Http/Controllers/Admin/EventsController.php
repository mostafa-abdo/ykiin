...
class EventsController extends Controller
{
    ...
    public function page_settings(){
        ...
        return view(self::BASE_PATH.'event-page-settings', compact('pages'));
    }
    ...
    public function update_page_settings(Request $request){
            ...
            $this->validate($request,[
                ...
                'event_terms_and_conditions' => 'nullable|string',
                'event_privacy_policy' => 'nullable|string',
            ]);
            ...
            $fields = [
                ...
                'event_privacy_policy',
                'event_page_qr_code_title',
                'event_page_qr_code_show_hide',
            ];
